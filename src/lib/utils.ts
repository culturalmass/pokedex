...
export function removeDuplicates<T>(data: T[]): T[] {
  return data.filter((id, index) => data.indexOf(id) === index);
}

export function sortArray(data: number[]) {
...
export const generation =
  "https://pokeapi.co/api/v2/generation?limit=50&offset=0";

export const region = "https://pokeapi.co/api/v2/region?limit=50&offset=0";

export const location =
  "https://pokeapi.co/api/v2/location?limit=1500&offset=0";
...
export const weakness = {
  ...
  psychic: ["bug", "flying", "dark"],
  bug: ["fire", "flying", "rock", "steel"],
